  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="mt-5 flex items-center gap-3">
        ...
        <span className="text-sm text-stone-500 font-['Manrope']">or continue with</span>
        <div className="h-px bg-stone-200 flex-1"></div>
      </div>

      {/* Social Login (Mock) */}
      <div className="mt-4 flex gap-3">
        <button className="flex-1 bg-stone-50 border border-stone-200 rounded-lg py-2.5 flex items-center justify-center hover:bg-stone-100 transition-colors text-zinc-950">
          <span className="text-sm font-medium font-['Manrope']">Google</span>
        </button>
        <button className="flex-1 bg-stone-50 border border-stone-200 rounded-lg py-2.5 flex items-center justify-center hover:bg-stone-100 transition-colors text-zinc-950">
          <span className="text-sm font-medium font-['Manrope']">Apple ID</span>
        </button>
      </div>
    </div>
  );
